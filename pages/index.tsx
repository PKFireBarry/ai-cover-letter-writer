  ...
  if (!auth.currentUser) {
    ...
    return (
      <>
        ...
        <div className="h-screen w-screen md:fixed font-serif">
          <Toaster
            position="top-center"
            reverseOrder={false}
            gutter={8}
          ...
          />
<div>
  <div className="w-screen h-20 bg-gray-900 flex justify-between items-center px-4 sm:px-8">
    <h1 className="text-lg font-bold text-white">Ai Coverletter Writer</h1>
    <div className="flex items-center space-x-4">
      ...
      />
      <h1 className="text-sm font-bold hidden sm:inline-block text-gray-300">
